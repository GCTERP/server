...
export const enrollment_Admin_GetEnrollmentStatus = async(req, res) => {
    try{
...
// Change the enrollment schedules
export const enrollment_Admin_ModifyEnrollmentStatus = async(req, res) => {
    try{
...
export const enrollment_Admin_GetEnrolledStudentsList = async(req, res) => {
    try{
...
// approve enrolled students
export const enrollment_Admin_AproveStudents = async(req, res) => {
    try{
...
//  add students to particular enrolled course..
export const enrollment_Admin_AddStudents = async(req, res) => {
    try{
        const {courses} = req.body
        let success = true
        let message = "All the changes have been modified"
...
export const enrollment_Admin_RemoveStudents = async(req, res) => {
    try{
